...
int order ()
{
    ...
    case 11 : {
        ...
        if (i==1) p[order_count].cost += (130);

        else p[order_count].cost += (180);
        break;
    }
    case 12 :{
        ...
        if (i==1) p[order_count].cost += (750);

        else if (i==2) p[order_count].cost += (975);

        else  p[order_count].cost += (1250);
    ...
    case 13 :{
        ...
        if (i==1) p[order_count].cost += (85);

        else if (i==2) p[order_count].cost += (320);

        else  p[order_count].cost += (790);
    ...
    case 14 :{
        ...
        if (i==1) p[order_count].cost += (70);

        else if (i==2) p[order_count].cost += (140);

        else  p[order_count].cost += (250);
    ...
    case 16 :{
        ...
        if (i==1) p[order_count].cost += (120);

        else p[order_count].cost += (240);
    ...
    case 20 :{
        ...
        if (i==1) p[order_count].cost += (20);

        else p[order_count].cost += (30);
        break;
    }
    default : {
...
int main ()
{
    printf ("\t\t     Welcome To Cafe House of Khagan\n");
    while (1){
        printf ("1. Order\n2. Serve\n3. Display \n4. Exit the program\n");
